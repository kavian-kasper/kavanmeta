import { theMachiavellian } from "../data/metatoonzData"
...
const TheMachiavellian = () => {

    const commonInfo = theMachiavellian[0]

    const primarySkin = theMachiavellian[1]
...
export default TheMachiavellian
