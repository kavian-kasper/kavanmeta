import { theExplorer } from "../data/metatoonzData"
...
const TheExplorer = () => {
    ...
    const commonInfo = theExplorer[0]

    const primarySkin = theExplorer[1]

    const secondarySkin = theExplorer[2]
