import { theEasyRider } from "../data/metatoonzData"
...
const TheEasyRider = () => {
    ...
    const commonInfo = theEasyRider[0]

    const primarySkin = theEasyRider[1]

    const secondarySkin = theEasyRider[2]
    ...
    const ThreeDViewPrimary= () => {
        return (
            <div className="mb-4">
                ...
                alt={commonInfo.threeDAlt} style={{backgroundColor: "rgb(230, 230, 230)", height: "420px", width: "auto"}} exposure="0.9" ar-status="not-presenting" loading="eager" camera-controls>
            </model-viewer>
        </div>
        )
    }
